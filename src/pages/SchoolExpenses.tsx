              ...
              <Col span={24}>
                ...
                >
                  ...
                  <Select placeholder="Select status">
                    ...
                    {/* 🛠️ FIX: backend's FeePayment enum only accepts
                        PARTIAL (not PARTIALLY_PAID / PARTIALLY) — sending
                        the old value failed with a JSON deserialize error
                        on update. Value corrected to match the enum;
                        label kept user-friendly. */}
