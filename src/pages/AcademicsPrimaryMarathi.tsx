    ...
    async function fetchClassRoom() {
      try {
        ...
        const res = await getAllClassRooms(0, 10, {
          ...
          medium: "Marathi", // adjust key name if your DTO uses mediumType / mediumName etc.
        }, controller.signal);
        ...
        if (err.name !== "CancelledError" && err.code !== "ERR_CANCELED") {
          console.log("Failed to fetch Secondary (Marathi ) classrrom data:", err);
